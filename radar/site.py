...
sourceNames:{'arxiv':'arXiv','crossref':'Crossref','semantic_scholar':'Semantic Scholar','huggingface':'Hugging Face','openreview':'OpenReview'}
},zh:{
...
familyNames:{'on-policy-distillation':'同策略蒸馏','rlvr-grpo':'RL 优化与可验证奖励','preference-optimization':'偏好优化','reasoning-self-improvement':'推理与自我改进','agentic-feedback':'智能体反馈与工具使用','multimodal-alignment':'多模态对齐','generative-alignment':'生成式媒体对齐','embodied-transfer':'具身与 VLA 迁移','data-feedback':'数据与反馈构造'},
...
let lang=storageGet('atlas-lang')||((navigator.language||'en').toLowerCase().startsWith('zh')?'zh':'en');
...
const sourceName=id=>t('sourceNames')[id]||id.replace(/_/g,' ');
